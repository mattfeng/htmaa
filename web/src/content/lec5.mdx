...
- cuts, burns, impacts, fires
    - chips are sharp
    - metal can look beautiful, actually **hot razer blades**
    - shopbot can catch on fire
- tool breaking
- glasses, shoes, clothes, hair, gloves
    - don't wear gloves when milling
- look, listen, smell
...
- group assignment
    ...
    - test the following for your machine
        - runout
        - alignment (square)
        - speeds
        - feeds
