...
- Arduino uses an older MCU: ATmega328
- SAMD11 can handle USB using its internal clock; Arduino needs another chip to translate serial to the ATmega
- Arduino uses crystals (XTALs)
